function startGame() {
    ...
    $("game_item").addEventListener("mouseover",(e) => {
        ...
        if (target.classList[0] === "item_block") {
            ...
            if (pointer === 1) {
                $("item_information").style.left = `${block.x - $("item_information").offsetWidth / 2 + block.width / 2}px`;
            ...
            $("item_information").style.top = `${block.y - $("item_information").offsetHeight + 2}px`;
        }
    });
